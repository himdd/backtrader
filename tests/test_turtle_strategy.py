...
if __name__ == '__main__':
    ...
    datapath = ('C:/Users/himdd/code/backtrader/datas/testbacktrader/tushare/300274.csv')
    dataframe = pd.read_csv(datapath, index_col=0, parse_dates=True)
    dataframe['openinterest'] = 0
    data = bt.feeds.PandasData(dataname=dataframe,fromdate=datetime.datetime(2022, 1, 1),  todate=datetime.datetime(2022, 12, 31))
